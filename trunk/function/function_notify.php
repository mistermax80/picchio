...
function generateNotificationFamily($filename,$id_booking,$id_client) {
	...
	$booking = getBookingById($id_booking);
	$client1 = getClient($booking['client']); 
	$client2 = getClient($id_client);
	...
	$name = $client1['name'];
	$city_birth = $client1['city_birth'];
	$nationality = $client1['nationality'];;
	$date_birth = $client1['date_birth'];
	$gg_birth = "23";
	$mm_birth = "02";
	$aa_birth = "80";
	$address = $client1['address'];
	$type_doc = $client1['type_document'];
	$num_doc = $client1['number_document'];
	$release_date = $client1['release_document_date'];
	$release_to = $client1['release_document_to'];

	//Another family component
	$surname2 = $client2['surname'];
	$name2 = $client2['name'];
	$city_birth2 = $client2['city_birth'];
	$date_birth2 = $client2['date_birth'];
